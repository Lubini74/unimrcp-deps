...
%configure --prefix=/opt/unimrcp $options
...
%package	devel
Summary:	UniMRCP Sofia-SIP Development Package
Group:		Development/Libraries
Requires:	unisofia-sip = %{version}-%{release}
...
%package	utils
Summary:	UniMRCP Sofia-SIP Command Line Utilities
